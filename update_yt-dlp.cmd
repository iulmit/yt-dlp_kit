...
::normal     -m pip install -U yt-dlp
::trunk      -m pip install --force-reinstall "https://github.com/yt-dlp/yt-dlp/archive/master.zip"
...
@echo on
::call "%STARTING_FOLDER%\resources\WPy32\python-3.10.2\python.exe" -m pip install -U yt-dlp
call "%STARTING_FOLDER%\resources\WPy32\python-3.10.2\python.exe" -m pip install --force-reinstall "https://github.com/yt-dlp/yt-dlp/archive/master.zip"
set "EXIT_CODE=%ErrorLevel%"
@echo off

call "%STARTING_FOLDER%\info_update.cmd"
